<nav class="bg-white shadow-md sticky top-0 z-50" x-data="{ open: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-8 font-medium text-sm tracking-wide uppercase">
                ...
                <a href="#tentang" class="text-gray-500 hover:text-gray-900 transition">Tentang Kami</a>
                ...
                <a href="#faq" class="text-gray-500 hover:text-gray-900 transition">FAQ</a>
                <a href="#kontak" class="bg-zinc-900 text-white px-5 py-2.5 rounded hover:bg-zinc-800 transition shadow">Kontak</a>
            </div>
    ...
    <div x-show="open" x-cloak class="md:hidden bg-white border-t border-gray-100 py-3 space-y-1 font-medium tracking-wide uppercase" @click.away="open = false">
        ...
        <a href="#tentang" @click="open = false" class="block px-4 py-2.5 text-gray-600 hover:bg-gray-50">Tentang Kami</a>
